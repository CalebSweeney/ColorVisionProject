...
int main()
{
  ...
  do{
    cout << "Please enter R for Protanopia, G for Deutranopia, and B for Tritanopia (Enter any other letter to exit the program):" << endl;
    cin >> selectedType;
    if(selectedType != 'R' && selectedType != 'G' && selectedType != 'B'){
